...
def format_request(requested: list) -> str:
...
def restore_briefings(log_file):
    ...
    with open(log_file) as logfile:
        ...
        try:
            ...
            return -3600, brief_time  # past hour is reported in case no 'BRIEF CALLED:' was found
...
def filtered(alarms: list, removed: list) -> list:
...
def formatted(alarms: list) -> list:
